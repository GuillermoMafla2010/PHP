...
<html>
    ...
    <h1> Alta de artículos nuevos</h1>
        ...
        <table>
        <tr><td>
            <label>Código Artículo:</label></td><td> <input type="text" name="codigo_articulo"></td></tr>
            <tr><td><label>Sección:</label></td><td><input type="text" name="seccion"></td></tr>
          <tr><td>  <label>Nombre Artículo:</label> </td><td><input type="text" name="nombre_articulo"></td></tr>
          <tr><td>  <label>Precio: </label></td><td><input type="text" name="precio"></td></tr>
           ...
           <tr><td> <label>País de Origen: </label></td><td><input type="text" name="pais_origen"></td></tr>
